...
func (*GeocodeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_geocoding_de26fb2469897a63, []int{0}
}
...
func (*GeocodeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_geocoding_de26fb2469897a63, []int{1}
}
...
func init() {
	proto.RegisterType((*GeocodeRequest)(nil), "geocoding.GeocodeRequest")
	proto.RegisterType((*GeocodeReply)(nil), "geocoding.GeocodeReply")
}
...
func (c *geocodeClient) Geocode(ctx context.Context, in *GeocodeRequest, opts ...grpc.CallOption) (*GeocodeReply, error) {
	...
	err := c.cc.Invoke(ctx, "/geocoding.Geocode/Geocode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Geocode_Geocode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/geocoding.Geocode/Geocode",
	}
...
func init() { proto.RegisterFile("geocoding.proto", fileDescriptor_geocoding_de26fb2469897a63) }

var fileDescriptor_geocoding_de26fb2469897a63 = []byte{
	// 176 bytes of a gzipped FileDescriptorProto
	,
}
